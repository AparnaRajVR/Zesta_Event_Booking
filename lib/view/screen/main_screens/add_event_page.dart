...
//     return Scaffold(
//       backgroundColor: Colors.AppColors.textlight,
...
import 'package:z_organizer/view/widget/add_event/event_form_body.dart';
...
class _AddEventScreenState extends ConsumerState<AddEventScreen> {
  ...
  // Non-static controllers that get properly disposed
  ...
  Widget build(BuildContext context) {
    final handlers = AddEventHandlers(
      formKey: _formKey,
  ...
  BoxDecoration _gradientDecoration() {
    return BoxDecoration(
      gradient: LinearGradient(
        ...
        colors: [AppColors.textlight, Colors.deepPurple.shade50.withOpacity(0.3)],
      ),
    );
  }
}